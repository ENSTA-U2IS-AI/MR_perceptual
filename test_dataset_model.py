...
parser.add_argument('--loss_type', type=str, default='MSE', help='[MSE,CE]')
parser.add_argument('--norm', type=str, default='l2', help='[l2,sigmoid,relu+l1]')
...
trainer.initialize(model=opt.model, net=opt.net, colorspace=opt.colorspace, 
	...
	version=opt.version, gpu_ids=opt.gpu_ids,loss_type=None,norm=None,feature=None,resolution=None,mrpl=False)
