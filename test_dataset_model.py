...
parser.add_argument('--model', type=str, default='mrpl', help='distance model type [lpips] for linearly calibrated net, [baseline] for off-the-shelf network, [l2] for euclidean distance, [ssim] for Structured Similarity Image Metric')
...
parser.add_argument('--resolution', type=str, nargs='+', default=['linear'], help='Resolution of the linear features : [x1,x2]')
parser.add_argument('--loss_type', type=str, default='CE', help='[MSE,CE]')
parser.add_argument('--norm', type=str, default='sigmoid', help='[l2,sigmoid,relu+l1]')
parser.add_argument('--mrpl', type=bool, default=True, help='Use the Multi Resolution Perceptual Loss presented in the paper')
