...
class alexnet(torch.nn.Module):
    ...
    def forward(self, X):
        ...
        if ('x1' in self.features) or ('quadratic' in self.features) :
        ...
        if self.MRPL or ('quadratic' in self.features):
        ...
        if self.MRPL :
            self.alexnet_outputs = namedtuple("AlexnetOutputs", ['X2relu2', 'X2relu3', 'X2relu4', 'X2relu5','gramrelu1', 'gramrelu2', 'gramrelu3', 'gramrelu4', 'gramrelu5'])
            out = self.alexnet_outputs(h_relu2_2,h_relu3_2, h_relu4_2, h_relu5_2, h_relu4, h_relu5,h_relu2_gram,h_relu3_gram,h_relu4_gram,h_relu5_gram)

        elif ('x1' in self.resolution) and ('x2' in self.resolution) and ('linear' in self.features) and ('quadratic' in self.features):
            self.alexnet_outputs = namedtuple("AlexnetOutputs", ['X2relu1','X2relu2', 'X2relu3', 'X2relu4', 'X2relu5','relu1','relu2','relu3','relu4','relu5', 'gramrelu1','gramrelu2', 'gramrelu3', 'gramrelu4', 'gramrelu5'])
            out = self.alexnet_outputs(h_relu1_2,h_relu2_2,h_relu3_2, h_relu4_2,h_relu5_2,h_relu1,h_relu2,h_relu3,h_relu4,h_relu5,h_relu1_gram,h_relu2_gram,h_relu3_gram,h_relu4_gram,h_relu5_gram)
            ...
            self.alexnet_outputs = namedtuple("AlexnetOutputs", ['relu1','relu2','relu3','relu4','relu5'])
            out = self.alexnet_outputs(h_relu1,h_relu2,h_relu3,h_relu4,h_relu5)

        elif (not('x1' in self.resolution)) and ('x2' in self.resolution) and ('linear' in self.features) and (not('quadratic' in self.features)):
            self.alexnet_outputs = namedtuple("AlexnetOutputs", ['X2relu1','X2relu2', 'X2relu3', 'X2relu4', 'X2relu5'])
            out = self.alexnet_outputs(h_relu1_2,h_relu2_2,h_relu3_2, h_relu4_2,h_relu5_2)

        elif ('x1' in self.resolution) and ('x2' in self.resolution) and ('linear' in self.features) and (not('quadratic' in self.features)):
            self.alexnet_outputs = namedtuple("AlexnetOutputs", ['X2relu1','X2relu2', 'X2relu3', 'X2relu4', 'X2relu5','relu1','relu2','relu3','relu4','relu5'])
            out = self.alexnet_outputs(h_relu1_2,h_relu2_2,h_relu3_2, h_relu4_2,h_relu5_2,h_relu1,h_relu2,h_relu3,h_relu4,h_relu5)
            ...
            self.alexnet_outputs = namedtuple("AlexnetOutputs", ['X2relu1','X2relu2', 'X2relu3', 'X2relu4', 'X2relu5','relu1','relu2','relu3','relu4','relu5'])
            out = self.alexnet_outputs(h_relu1_2,h_relu2_2,h_relu3_2, h_relu4_2,h_relu5_2,h_relu1_gram,h_relu2_gram,h_relu3_gram,h_relu4_gram,h_relu5_gram)
            ...
            self.alexnet_outputs = namedtuple("AlexnetOutputs", ['gramrelu1','gramrelu2', 'gramrelu3', 'gramrelu4', 'gramrelu5'])
            out = self.alexnet_outputs(h_relu1_gram,h_relu2_gram,h_relu3_gram,h_relu4_gram,h_relu5_gram)
